...
public static class Constants{
    ...
    public const string gameModeName_Mode1 = "Classicmode";
    public const string gameModeName_Mode2 = "ModernMode";
    public const string gameModeName_Mode3 = "MissionMode";
    public const string gameModeName_Mode4 = "TimerMode";
    public const string gameModeName_Mode5 = "SnowMode";
    public const string gameModeName_TrainingMode = "TimerMode";
