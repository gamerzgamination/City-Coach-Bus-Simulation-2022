...
public class PathManager : MonoBehaviour
{
	...
	public Color color2 = new Color(1f, 47f / 51f, 0.0156862754f, 0.5f);

	public Color color3 = new Color(1f, 47f / 51f, 0.0156862754f, 0.5f);
	...
	private void DrawCurved()
	{
		if (waypoints.Length >= 2)
		{
			...
			{
				ref Vector3 reference = ref points[i + 1];
				reference = waypoints[i].position;
			}
			ref Vector3 reference2 = ref points[0];
			reference2 = points[1];
			ref Vector3 reference3 = ref points[points.Length - 1];
			reference3 = points[points.Length - 2];
			Gizmos.color = color3;
