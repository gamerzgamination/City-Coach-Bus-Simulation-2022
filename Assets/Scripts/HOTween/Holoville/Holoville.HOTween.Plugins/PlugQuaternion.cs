...
public class PlugQuaternion : ABSTweenPlugin
{
	...
	protected override object startVal
	{
		...
		set
		{
			...
			{
				typedStartVal = typedEndVal + ((value is Quaternion quaternion) ? quaternion.eulerAngles : ((Vector3)value));
	...
	public PlugQuaternion(Quaternion p_endVal)
		: base(p_endVal, p_isRelative: false)
	{
	}

	public PlugQuaternion(Quaternion p_endVal, EaseType p_easeType)
		: base(p_endVal, p_easeType, p_isRelative: false)
	{
	}
	...
	{
		return Beyond360(p_beyond360: true);
	}
