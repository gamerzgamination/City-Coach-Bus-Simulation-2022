...
public abstract class ABSTweenComponent : IHOTweenComponent
{
	...
	public void Kill()
	{
		Kill(p_autoRemoveFromHOTween: true);
	}
	...
	{
		Complete(p_doAutoKill: true);
	}

	public bool GoTo(float p_time)
	{
		return GoTo(p_time, p_play: false, p_forceUpdate: false, p_ignoreCallbacks: false);
	}

	public bool GoTo(float p_time, bool p_forceUpdate)
	{
		return GoTo(p_time, p_play: false, p_forceUpdate, p_ignoreCallbacks: false);
	}

	internal bool GoTo(float p_time, bool p_forceUpdate, bool p_ignoreCallbacks)
	{
		return GoTo(p_time, p_play: false, p_forceUpdate, p_ignoreCallbacks);
	}

	public bool GoToAndPlay(float p_time)
	{
		return GoTo(p_time, p_play: true, p_forceUpdate: false, p_ignoreCallbacks: false);
	}

	public bool GoToAndPlay(float p_time, bool p_forceUpdate)
	{
		return GoTo(p_time, p_play: true, p_forceUpdate, p_ignoreCallbacks: false);
	}

	internal bool GoToAndPlay(float p_time, bool p_forceUpdate, bool p_ignoreCallbacks)
	{
		return GoTo(p_time, p_play: true, p_forceUpdate, p_ignoreCallbacks);
	}
	...
	{
		ApplyCallback(p_wParms: false, p_callbackType, p_callback, null, null);
	}
	...
	{
		ApplyCallback(p_wParms: true, p_callbackType, null, p_callback, p_callbackParms);
	}
	...
	public void ApplyCallback(CallbackType p_callbackType, GameObject p_sendMessageTarget, string p_methodName, object p_value, SendMessageOptions p_options = SendMessageOptions.RequireReceiver)
	{
		...
		ApplyCallback(p_wParms: true, p_callbackType, null, p_callbackWParms, p_callbackParms);
	}
	...
	{
		return Update(p_elapsed, p_forceUpdate: false, p_isStartupIteration: false, p_ignoreCallbacks: false);
	}

	internal bool Update(float p_elapsed, bool p_forceUpdate)
	{
		return Update(p_elapsed, p_forceUpdate, p_isStartupIteration: false, p_ignoreCallbacks: false);
	}

	internal bool Update(float p_elapsed, bool p_forceUpdate, bool p_isStartupIteration)
	{
		return Update(p_elapsed, p_forceUpdate, p_isStartupIteration, p_ignoreCallbacks: false);
	}
